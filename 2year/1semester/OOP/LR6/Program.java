...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        TabulatedFunction expForIntegral = TabulatedFunctions.tabulate(new Exp(), -1, 2, 10);
        outputFuncWithStep(expForIntegral, -1, 2, 0.5, format);
        double expIntegral = Functions.integrate(expForIntegral, 0, 1, 0.1);
